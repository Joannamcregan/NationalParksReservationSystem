...
SET @fromDate = '2019-10-18'

DECLARE @toDate date
SET @toDate = '2019-10-19'

select s.* FROM site s
	JOIN reservation r ON s.site_id = r.site_id
	WHERE (r.from_date NOT between @fromDate AND @toDate
	AND r.to_date NOT between @fromDate AND @toDate) AND (@fromDate NOT BETWEEN r.from_date AND r.to_date AND @toDate NOT BETWEEN r.from_date AND r.to_date)
...
SELECT * FROM site s
WHERE (SELECT COUNT(*) FROM reservation r WHERE r.from_date between '2018-11-28' AND '2018-11-30' AND r.to_date between '2018-11-28' AND '2018-11-30')= 0
	
	AND r.to_date between '2019-10-24' AND '2019-10-31'
